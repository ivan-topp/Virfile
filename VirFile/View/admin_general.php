	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-xs-3" style="padding-left: 5vh;padding-right: 5vh; height: 100vh; background-color: #8181F7">
				<div class="row" style="background-color: #8181F7;height: 20vh; padding-left: 5vw; padding-right: 1vw;padding-top: 1vw; font-family: Century Gothic, Georgia; -webkit-user-select: none; -moz-user-select: none;-khtml-user-select: none;-ms-user-select:none;">
				...
				<br>
				<div class="row" style="background-color: #A4A400;height: 7.5vh; padding-left: 0vw; padding-top: 1.1vw; font-family: Century Gothic, Georgia; border-style: outset; -webkit-user-select: none; -moz-user-select: none;-khtml-user-select: none;-ms-user-select:none;">
					<div style="text-align: center;">Register Enterprice</div>
				</div>
				<br>
				<div class="row" style="background-color: #A4A4FF;height: 7.5vh; padding-left: 0vw; padding-top: 1.1vw; font-family: Century Gothic, Georgia; border-style: outset; -webkit-user-select: none; -moz-user-select: none;-khtml-user-select: none;-ms-user-select:none;">
					<div style="text-align: center;">Register User</div>
				</div>
				<br>
				<div class="row" style="background-color: #A4A4AA;height: 7.5vh; padding-left: 0vw; padding-top: 1.1vw; font-family: Century Gothic, Georgia; border-style: outset; -webkit-user-select: none; -moz-user-select: none;-khtml-user-select: none;-ms-user-select:none;">
